<template>
  ...
  <footer class="text-center bg-[#165AAD] text-white px-[3rem] absolute top-0 right-0 left-0">
    <div class="container mx-auto px-6 pt-6">
      ...
      <div class="grid lg:grid-cols-4 md:grid-cols-2">
          ...
          <ul class="list-none mb-0">
            <li>
              <a href="#!" class="text-white">
                ...
                dolore magna aliqua. Ultrices dui sapien eget mi proin sed libero.
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="mb-6 px-4">
          ...
          <ul class="list-none mb-0">
            <li>
              <a href="#!" class="text-white"> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                tempor incididunt ut labore et dolore magna aliqua. Ultrices dui sapien eget mi proin sed libero. </a>
            </li>
          </ul>
        </div>
