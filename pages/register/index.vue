<template>
  <div class="container mx-auto">
    <div class="bg-no-repeat bg-cover bg-center relative"
      ...
      <div class="absolute hidden md:block bg-gradient-to-b from-[#165AAD] to-blue-500 opacity-75 inset-0 "></div>
      <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
        ...
        <div class="flex justify-center self-center  z-[1000]">
          <div class="p-12 bg-white mx-auto rounded-2xl w-100 ">
            <div class="mb-4">
              <h3 class="font-semibold text-2xl text-gray-800">Sign In </h3>
              <p class="text-gray-500">Please register to your account.</p>
            </div>
            <div class="space-y-5">
              <div class="space-y-2">
              ...
              <div>
                <button type="submit"
                        class="w-full flex justify-center bg-[#165AAD] text-gray-100 p-3  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                  Register
                </button>
              </div>
            </div>
