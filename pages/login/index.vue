      ...
      <div class="flex justify-center self-center  z-[1000]">
        <div class="p-12 bg-white mx-auto rounded-2xl w-100 ">
          ...
          <div class="space-y-5">
            ...
            <div>
              <button type="submit" class="w-full flex justify-center bg-[#165AAD] text-gray-100 p-3  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                Sign in
              </button>
            </div>
          </div>
